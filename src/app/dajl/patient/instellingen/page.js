...
async function addDataToFirestore (pause, brightness) {
      try {
            ...
            // MQTT can not receive objects, turn the value into a string before sending it
...
export default function Instellingen() {
      ...
      <button type="submit" onClick={() => addDataToFirestore({pause}, {brightness})}>Instellingen Opslaan</button>
